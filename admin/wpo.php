...
$plugins   = stsuite_wpo_plugins_info();
$autoload   = stsuite_wpo_autoload_stats();
$transients = stsuite_wpo_transient_stats();
$cron       = stsuite_wpo_cron_info();
$cache      = stsuite_wpo_cache_info();
$env        = stsuite_wpo_env_versions();
...
<div class="wrap">
    ...
    <div class="stsuite-card">
        ...
        <p class="stsuite-kv"><?php esc_html_e('Installed:', 'sysadmin-total-suite'); ?> <strong><?php echo (int) $plugins['total']; ?></strong> ·
           <?php esc_html_e('Active:', 'sysadmin-total-suite'); ?> <strong><?php echo (int) $plugins['active']; ?></strong> ·
           <?php esc_html_e('Inactive:', 'sysadmin-total-suite'); ?> <strong><?php echo (int) $plugins['inactive']; ?></strong>
           <span class="stsuite-badge <?php echo $plugins_warn ? 'warn' : 'ok'; ?>">
               <?php echo $plugins_warn ? esc_html__('Many active plugins', 'sysadmin-total-suite') : esc_html__('Reasonable amount', 'sysadmin-total-suite'); ?>
           </span>
        </p>
    ...
    <div class="stsuite-card">
        ...
        <p class="stsuite-kv">
            <?php esc_html_e('Autoload options:', 'sysadmin-total-suite'); ?> <strong><?php echo (int) $autoload['count']; ?></strong> ·
            <?php esc_html_e('Total autoload size:', 'sysadmin-total-suite'); ?> <strong><?php echo esc_html(size_format($autoload['total_bytes'], 2)); ?></strong>
            <span class="stsuite-badge <?php echo $autoload_warn ? 'warn' : 'ok'; ?>">
                <?php echo $autoload_warn ? esc_html__('High (>1 MB)', 'sysadmin-total-suite') : esc_html__('OK', 'sysadmin-total-suite'); ?>
            </span>
        </p>
        <p class="stsuite-kv">
            <?php esc_html_e('Transients with expiration:', 'sysadmin-total-suite'); ?> <strong><?php echo (int) $transients['total']; ?></strong> ·
            <?php esc_html_e('Expired (junk):', 'sysadmin-total-suite'); ?> <strong class="stsuite-num-warn"><?php echo (int) $transients['expired']; ?></strong>
        </p>
    ...
    <div class="stsuite-card">
        ...
        <p class="stsuite-kv">
            <?php esc_html_e('Scheduled tasks:', 'sysadmin-total-suite'); ?> <strong><?php echo (int) $cron['total']; ?></strong> ·
            <?php esc_html_e('Overdue:', 'sysadmin-total-suite'); ?> <strong><?php echo (int) $cron['overdue']; ?></strong>
            <?php if ($cron['overdue'] > 0): ?><span class="stsuite-badge warn"><?php esc_html_e('There are overdue tasks', 'sysadmin-total-suite'); ?></span><?php endif; ?>
            · <?php esc_html_e('Orphaned:', 'sysadmin-total-suite'); ?> <strong class="stsuite-num-warn"><?php echo (int) $cron['orphaned']; ?></strong>
            <?php if ($cron['orphaned'] > 0): ?><span class="stsuite-badge warn"><?php esc_html_e('Junk from removed plugins', 'sysadmin-total-suite'); ?></span><?php endif; ?>
        </p>
    ...
    <div class="stsuite-card">
        ...
        <p class="stsuite-kv"><?php esc_html_e('Web server:', 'sysadmin-total-suite'); ?>
            <strong><?php echo $cache['server_software'] ? esc_html($cache['server_software']) : esc_html__('unknown', 'sysadmin-total-suite'); ?></strong>
            <?php if ($cache['server_is_ls']): ?><span class="stsuite-badge ok">LiteSpeed</span><?php endif; ?>
        </p>
        <p class="stsuite-kv"><?php esc_html_e('Active cache plugin(s):', 'sysadmin-total-suite'); ?>
            <strong><?php echo $cache['plugins'] ? esc_html(implode(', ', $cache['plugins'])) : esc_html__('none', 'sysadmin-total-suite'); ?></strong>
        </p>
        ...
        <?php if ($cache['page_method'] === 'litespeed'): ?>
            <p class="stsuite-kv"><?php esc_html_e('Page cache (LiteSpeed, server level):', 'sysadmin-total-suite'); ?>
                ...
                <?php else: ?>
                    <strong><?php echo $cache['server_is_ls'] ? esc_html__('active (LiteSpeed server detected)', 'sysadmin-total-suite') : esc_html__('state not readable', 'sysadmin-total-suite'); ?></strong>
                <?php endif; ?>
            </p>
        ...
        <?php else: ?>
            <p class="stsuite-kv"><?php esc_html_e('Page cache (WP_CACHE + advanced-cache.php):', 'sysadmin-total-suite'); ?>
                <strong><?php echo $cache['page_cache_active'] ? esc_html__('enabled', 'sysadmin-total-suite') : esc_html__('not enabled', 'sysadmin-total-suite'); ?></strong>
            </p>
        <?php endif; ?>

        <p class="stsuite-kv"><?php esc_html_e('Object cache (object-cache.php):', 'sysadmin-total-suite'); ?>
            <strong><?php echo $cache['object_cache'] ? esc_html__('present', 'sysadmin-total-suite') : esc_html__('not present', 'sysadmin-total-suite'); ?></strong>
        </p>
    </div>
    ...
    <div class="stsuite-card">
        ...
        <table class="stsuite-table">
            <tbody>
                ...
                <tr><td><?php esc_html_e('Database', 'sysadmin-total-suite'); ?></td><td><strong><?php echo esc_html($env['db_type'] . ' — ' . $env['db_server_info']); ?></strong></td></tr>
